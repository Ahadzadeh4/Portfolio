...
function Services() {
    const ServicesIcon: Record<string, any> = {
    ...
    return (
        ...
        dark:text-white ">
                <div className="max-w-7xl mx-auto px-4 py-20 font-vazir items-center justify-center my-auto">
                    <div >
                        <h1 className="text-center lg:text-5xl sm:max-lg:text-3xl sm:max-lg:mb-3 p-3 lg:mb-3 font-bold min-[300px]:text-3xl min-[300px]:mb-2">{data?.Services?.[0]?.title}</h1>
                    ...
                    <div>
                        <div className="grid lg:grid-cols-3 md:grid-cols-2 min-[300px]:grid-cols-1 gap-7 justify-center py-3 md:[&>div:nth-child(odd)]:justify-self-end
    md:[&>div:nth-child(even)]:justify-self-start lg:[&>div:nth-child(odd)]:justify-self-center lg:[&>div:nth-child(even)]:justify-self-center">
                            {data?.Services?.[0]?.services.map((item: any) => (
                                <div key={item.id} className="w-[320px] dark:bg-white/6 h-[392px]  transition-all
        duration-700  shadow-xl rounded-xl px-1 py-4 justify-center items-center bg-white justify-self-center">
                                    <div className="flex flex-col flex-nowrap gap-2 text-center justify-center items-center">
                                        <div className="m-4">
                                            <FontAwesomeIcon icon={ServicesIcon[item.fontawesome]} className="text-7xl text-blue-600"></FontAwesomeIcon>
                                        </div>
                        ...
                        <div >
                            <div className="py-1 pt-3 ">
                                <div className="flex flex-col flex-nowrap justify-center text-center">
                                    ...
                                    <ul className="grid sm:grid-cols-3 min-[300px]:grid-cols-1 gap-3 py-3 justify-center">
