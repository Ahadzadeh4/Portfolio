                ...
                <div className="flex flex-1 justify-center items-center">
                    <div >
                        <main className="text-center pb-[45px] sm:max-lg:pb-[30px] font-vazir font-normal sm:max-lg:text-sm min-[300px]:px-4">
                            <h1 className="text-6xl min-[1850px]:text-7xl sm:max-lg:text-5xl p-3 font-bold min-[300px]:text-5xl">حسین احدزاده</h1>
                            <p className="text-(--MyCB) pb-2 sm:max-lg:pb-1.5 dark:text-white">برنامه نویس فرانت اند</p>
                            <p className="text-(--MyCB) pb-8 sm:max-lg:pb-6 dark:text-white">سلام . حسین هستم طراح سایت سمت فرانت اند . بیاید بیشتر با من آشنا شوید</p>
